...
const title = ref(`Velocidade da conexão em KB /8 para encontrar a taxa de transmissão exe:`)
</script>
<template>
  <div>
    <div class="containerPost">
      <link
        rel="stylesheet"
        href="/src/styles/ContainerPosts.css" />
      <article>
        <p>{{ title }}</p>
        <figure>
        ...
        <h3 style="margin: 20px 0">Exemplo 1: Arquivos de 15MB em um enlace de 600KB ?</h3>
