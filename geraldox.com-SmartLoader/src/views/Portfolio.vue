  ...
  <div>
    ...
    <section class="cards">
      <div class="card" v-for="card in cards" :key="card.id">
        ...
        <section class="techs">
          <span class="techs_svg" v-html="card.techsvg[0]"></span>
          <span class="techs_svg" v-html="card.techsvg[1]"></span>
          <span class="techs_svg" v-html="card.techsvg[2]"></span>
        </section>
      </div>
    </section>
  </div>
    ...
    return {
      cards: [
        ...
        },
        {
          ...
          img: 'https://gifdb.com/images/high/tom-and-jerry-ping-pong-bounce-loop-6z19kkg1gqzhjby0.gif',
          link: 'https://bing.com',
          tech: 'VueJS',
          techsvg: [vuejs],
        },
